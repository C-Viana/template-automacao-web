...
public class DynamicLoadingSteps {
    ...
    public void confirmoAcessPaginaDynamicLoading() {
        ...
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Então confirmo o acesso à página Dynamic Loading");
    }
    ...
    public void selecionarLinkExemplo1() {
        ...
        page.getBtnStart();
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "E selecionar o link do exemplo 1");
    }
    ...
    public void confirmoHaElementoOculto() {
        ...
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Então confirmo que há um elemento oculto");
    }
    ...
    public void habilitoElementoPagina() {
        ...
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Clicando no botão 'Start'");
        ...
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "E habilito esse elemento na página");
    }
    ...
    public void selecionarLinkExemplo2() {
        ...
        page.getBtnStart();
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "E selecionar o link do exemplo 2");
    }
    ...
    public void confirmoNaoHaElementoOculto() {
        ...
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Então confirmo que não há elemento oculto");
    }
