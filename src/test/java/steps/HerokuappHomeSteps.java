...
public class HerokuappHomeSteps {
    ...
    public void queAbriAPaginaHerokuapp() {
        ...
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Dado que abri a página HerokuApp");
    }
    ...
    public void acessarOLinkABTesting() {
        ...
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Quando acessar o link A/B Testing");
    }
    ...
    public void acessarOLinkAddRemoveElements() {
        ...
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Quando acessar o link Add/Remove Elements");
    }
    ...
    public void acessarOLinkBasicAuth() {
        ...
        home.clickBasicAuth();
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Quando acessar o link Basic Auth");
    }
    ...
    public void acessarOLinkBrokenImages() {
        ...
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Quando acessar o link Broken Images");
    }
    ...
    public void acessarOLinkChallengingDOM() {
        ...
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Quando acessar o link Challenging DOM");
    }
    ...
    public void acessarOLinkContextMenu() {
        ...
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Quando acessar o link Context Menu");
    }
    ...
    public void acessarOLinkDigestAuthentication() {
        ...
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Quando acessar o link Digest Authentication");
    }
    ...
    public void acessarOLinkDisappearingElements() {
        ...
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Quando acessar o link Disappearing Elements");
    }
    ...
    public void acessarOLinkDragAndDrop() {
        ...
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Quando acessar o link Drag and Drop");
    }
    ...
    public void acessarOLinkDropdown() {
        ...
        home.clickDropdown();
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Quando acessar o link Dropdown");
    }
    ...
    public void acessarOLinkDynamicContent() {
        ...
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Quando acessar o link Dynamic Content");
    }
    ...
    public void acessarOLinkDynamicControls() {
        ...
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Quando acessar o link Dynamic Controls");
    }
    ...
    public void acessarOLinkDynamicLoading() {
        ...
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Quando acessar o link Dynamic Loading");
    }
    ...
    public void acessarOLinkEntryAd() {
        ...
        home.clickEntryAd();
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Quando acessar o link Entry Ad");
    }
    ...
    public void acessarOLinkExitIntent() {
        ...
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Quando acessar o link Exit Intent");
    }
    ...
    public void acessarOLinkFileDownload() {
        ...
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Quando acessar o link File Download");
    }
    ...
    public void acessarOLinkFileUpload() {
        ...
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Quando acessar o link File Upload");
    }
    ...
    public void acessarOLinkFrames() {
        ...
        home.clickFrames();
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Quando acessar o link Frames");
    }
    ...
    public void acessarOLinkHorizontalSlider() {
        ...
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Quando acessar o link Horizontal Slider");
    }
    ...
    public void acessarOLinkHover() {
        ...
        home.clickHover();
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Quando acessar o link Hover");
    }
    ...
    public void acessarOLinkJQueryUI() {
        ...
        home.clickJQueryUI();
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Quando acessar o link JQuery UI");
    }
    ...
    public void acessarOLinkJavaScriptAlerts() {
        ...
        ReportManager.setTestStep(ReportManager.getScenario().getStatus(), "Quando acessar o link JavaScript Alerts");
    }
